...
def plot_embedding_2d(X, y, dataset, title=None):
    ...
    # plt.legend()
    # plt.savefig('images/digits_tsne-pca.png', dpi=1000,format='eps')
    # plt.show()
    plt.savefig('result/DJANet/vis/save_inttra_inter/{}/{}_digits_tsne.png'.format(dataset, dataset), dpi=100,format='png')
