...
save_data_path = '/root/autodl-tmp/dataset/SYSU-MM01_generate_2/'
...
id_train.extend(id_test)  # id_test
...
def read_imgs(train_image, files_rgb):
    ...
    if files_rgb in "files_rgb":
        ...
        for index, img_path in enumerate(train_image):
            print("all", len(train_image), "index: ", index, "img_path: ", img_path)
