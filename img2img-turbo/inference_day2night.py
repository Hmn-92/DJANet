...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_image', type=str, default="/root/autodl-tmp/dataset/RegDB/Thermal/1/male_front_t_00007_1.bmp", help='path to the input image')
    ...
    parser.add_argument('--model_name', type=str, default="rainy_to_clear", help='name of the pretrained model to be used')
