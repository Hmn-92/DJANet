...
if __name__ == "__main__":
    ...
    # root = "/root/autodl-tmp/dataset/LLCM/test_nir"

    # 遍历文件夹下的所有图像文件
    # for dirpath, cams, _ in os.walk(root):
    #     for cam in cams:
    #         dir_root = os.path.join(root, cam)
    #         for filenames in os.listdir(dir_root):
    #             filenames_root = os.path.join(root, cam, filenames)
    #             for file in os.listdir(filenames_root):
    #
    #                 input_image_path = os.path.join(root, cam, filenames,file)
    ...
    root = "/root/autodl-tmp/dataset/LLCM/test_nir"
    output_dir = "/root/autodl-tmp/dataset/LLCM/test_nir_generated"
        ...
        for cam in cams:
            ...
            for filenames in os.listdir(dir_root):
                ...
                for file in os.listdir(filenames_root):
                    ...
                    save_output_dir = os.path.join(output_dir, cam, filenames)
