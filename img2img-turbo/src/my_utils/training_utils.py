...
def parse_args_paired_training(input_args=None):
   ...
   """
    ...
    parser.add_argument("--tracker_project_name", type=str, default="gparmar_unpaired_h2z_cycle_debug_v2", help="The name of the wandb project to log to.")
...
def parse_args_unpaired_training():
   ...
   """
    ...
    parser.add_argument("--dataset_folder",  type=str, default="data/my_Infrared2Visible")
    parser.add_argument("--train_img_prep",  default="resize_192x384")
    ...
    parser.add_argument("--output_dir", type=str,  default="output/cyclegan_turbo/my_Infrared2Visible")
    parser.add_argument("--report_to", type=str, default="wandb")
    parser.add_argument("--tracker_project_name", type=str,  default="gparmar_unpaired_h2z_cycle_debug_v2")
...
def build_transform(image_prep):
    ...
    elif image_prep == "resize_192x384":
        T = transforms.Compose([
            transforms.Resize((192, 384), interpolation=Image.LANCZOS)
        ])

    elif image_prep == "resize_256":
        T = transforms.Compose([
